...
# --- 設定 ---
STRATEGIES = ['balance', 'formation', 'kelly', 'odds_divergence']
...
def run_vectorized_simulation():
            ...
            for strat in STRATEGIES:
                for bud in BUDGETS:
                    ...
                    try:
                        ...
                        recs = BettingAllocator.allocate_budget(race_df_preds, bud, strategy=strat, odds_data=odds_data)
                        if recs:
                            for rec in recs:
    ...
    # Report
    report_path = 'simulation_report_strategy_comparison_random_500.md'
    with open(report_path, 'w', encoding='utf-8') as f:
        f.write("# 戦略比較シミュレーションレポート（ランダム500レース）\n\n")
