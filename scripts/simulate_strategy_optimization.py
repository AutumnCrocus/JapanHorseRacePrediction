...
# --- 設定 ---
STRATEGIES = ['formation', 'formation_flex', 'balance', 'balance_flex']
BUDGETS = [5000, 10000]
MODEL_PATH = os.path.join(MODEL_DIR, 'experiment_model_2025.pkl')
BATCH_SIZE = 100 # バッチサイズ (レース数)
...
def run_vectorized_simulation():
    ...
    # Report
    report_path = 'simulation_report_strategy_optimization.md'
    with open(report_path, 'w', encoding='utf-8') as f:
        f.write("# 戦略最適化シミュレーションレポート\n\n")
